...
MIGRATION_MODULES = {"sites": "artmart_backend.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "artmart_backend.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Hassam Jawed""", "syedhassam2001@gmail.com")]
...
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "artmart_backend.users.forms.UserSocialSignupForm"}
# django-compressor
# ------------------------------------------------------------------------------
...
SPECTACULAR_SETTINGS = {
    "TITLE": "artmart_backend API",
    "DESCRIPTION": "Documentation of API endpoints of artmart_backend",
    "VERSION": "1.0.0",
...
# Production setting: Allow specific origins
